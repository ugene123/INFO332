...
check6 <- n_levels(3, gapminder) # year --> shoulb be an empty data frame
...
# use an anonymous function (i.e. every thing should fit within one line of code)
